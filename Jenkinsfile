pipeline {
  ...
  stages {
    ...
    stage("Scarf.sh package registry"){
      ...
      steps{
        sh '''#! /bin/bash
              PACKAGE_UUID=$(curl -X GET -H "Authorization: Bearer ${SCARF_TOKEN}" https://scarf.sh/api/v1/organizations/linuxserver-ci/packages | jq -r '.[] | select(.name=="linuxserver/unifi-network-application") | .uuid' || :)
              if [ -z "${PACKAGE_UUID}" ]; then
                echo "Adding package to Scarf.sh"
                curl -sX POST https://scarf.sh/api/v1/organizations/linuxserver-ci/packages \
                  -H "Authorization: Bearer ${SCARF_TOKEN}" \
                  -H "Content-Type: application/json" \
                  -d '{"name":"linuxserver/unifi-network-application",\
                       "shortDescription":"example description",\
                       "libraryType":"docker",\
                       "website":"https://github.com/linuxserver/docker-unifi-network-application",\
                       "backendUrl":"https://ghcr.io/linuxserver/unifi-network-application",\
                       "publicUrl":"https://lscr.io/linuxserver/unifi-network-application"}' || :
              else
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-unifi-network-application/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-unifi-network-application\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-unifi-network-application\" \
